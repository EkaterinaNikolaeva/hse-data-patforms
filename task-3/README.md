...
- **Создание staging таблицы** - создание временной таблицы для первоначальной загрузки данных
- **Создание партиционированной таблицы** - создание таблицы `trademarks` с партицией по году (INT)
...
**Особенности:**
- Автоматическая обработка BOM символов в CSV файле
- Пропуск записей с некорректными или пустыми датами
- Использование динамического партиционирования Hive
- Автоматическое извлечение года из формата даты YYYYMMDD
