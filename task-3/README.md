...
- **Загрузка в HDFS** - загрузка CSV файла в staging директорию HDFS
...
- **Создание staging таблицы** - создание временной таблицы для первоначальной загрузки данных с использованием OpenCSVSerde для корректного парсинга CSV
- **Создание партиционированной таблицы** - создание таблицы `trademarks` с партицией по году (INT) с использованием OpenCSVSerde
